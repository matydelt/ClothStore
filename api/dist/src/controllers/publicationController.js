...
class PublicationController {
    ...
    static putPublications(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const charXPage = 12;
                let allPublications;
                allPublications = yield publication_1.default.find({ stock: { $gt: 0 } }).populate('discount');
    ...
    static getPublication(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { publicationId } = req.query;
                const publication = yield publication_1.default.findById(publicationId).populate('discount');
                if (publication) {
    ...
    static getRelatedPublications(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const publications = yield publication_1.default.find({ category: publication === null || publication === void 0 ? void 0 : publication.category, stock: { $gt: 0 }, gender: publication === null || publication === void 0 ? void 0 : publication.gender, name: { $ne: publication === null || publication === void 0 ? void 0 : publication.name } }).populate('discount').limit(12);
                if (publication) {
    ...
    static getPublicationsByUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { authorId } = req.query;
                const publications = yield publication_1.default.find({ author: authorId }).populate('discount');
                if (publications) {
                    res.json(publications);
                }
                else {
    ...
    static getAllPublication(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const publications = yield publication_1.default.find({ state: false, isRejected: false });
                if (publications) {
                    res.json(publications);
                }
                else {
