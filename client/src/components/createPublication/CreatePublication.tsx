...
import { Avatar, Container, Grid, InputAdornment, InputLabel, MenuItem, Typography, Divider,  CircularProgress, SelectChangeEvent } from '@mui/material';
import { TextField, Button, Badge, makeStyles, Select, FormControl, Input, Tooltip } from "@material-ui/core";
    ...
    <Box sx={{ backgroundColor: '#eeeeee', height: '120vh', }}>
      ...
      <Box sx={{ mt: 0, display: 'flex', justifyContent: 'center' }}>
        ...
        <Container sx={{ height: '100vh' }}>
          <Typography variant="h4" component="h4" sx={{ margin: '47px 0px' }} align='center'>
            ...
            <Tooltip title="Debes completar los campos y subir al menos una imagen para realizar la publicación">
              <HelpOutlineIcon color="primary" fontSize="large" classes={{ root: classes.help }}></HelpOutlineIcon>
          ...
          <Grid
            ...
            autoComplete="off"
            container
            boxShadow={1} sx={{ backgroundColor: 'white', padding: '25px', borderRadius: 2, justifyContent: 'center' }}>
            ...
            <Grid item xs={6} sx={{ mt: 4 }}>
...

              {
                form.images.length > 0 ? form.images.map((image: any) => {
                  ...
                  >
                    <Box component='a' href={image.url} target="_blank" rel="noopener noreferrer">
                      <Avatar
                        alt="image"
                        src={image.url}
                  ...
                  <Box component='div' sx={{ mt: 10 }}>
                    ...
                    <Box component='div' sx={{ display: 'flex', justifyContent: 'center' }}>
                      <ImageNotSupportedOutlined fontSize='large' color="disabled" sx={{ fontSize: '200px', display: 'flex' }} />
                    </Box>
                  </Box>
