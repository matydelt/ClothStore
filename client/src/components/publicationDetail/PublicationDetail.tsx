        ...
        <Box sx={{ mt: 0, display: "flex", justifyContent: "center" }}>
          <Container sx={{ mt: -18, position: "absolute" }}>
            ...
            >
              ...
              >
                {publication &&
                  publication?.images?.map((img) => {
                    return (
                      <span onMouseEnter={() => imageToShow(img.url)}>
                        <Avatar
                          sx={{
                            mt: 2,
                            width: 50,
              ...
              >
                {imageShow && (
                  <Avatar
                    src={imageShow}
                    variant="square"
                    sx={{ width: 470, height: 470, borderRadius: 1 }}
                    alt=""
                  />
                )}
              </Grid>
              ...
              >
                <Typography>
                  <p>Marca: {publication && publication?.mark}</p>
                </Typography>

                <Typography>
                  <p>Categoría: {publication && publication?.categorie}</p>
                </Typography>
                ...
                <Typography>
                  <p>{publication && publication?.detail}</p>
                </Typography>
