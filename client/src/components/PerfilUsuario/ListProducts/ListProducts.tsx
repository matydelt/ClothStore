...
export default function ListProducts(props: User) {
  ...
  function getPublications(): void {
    axios
      .get(`/publications`, { params: { authorId: props.id } })
      .then(({ data }) => {
        setArticulos(data);
      });
  }
                ...
                {articulos?.map((e) => (
                  <TableRow key={e.name} className={classes.tableRow}>
                      ...
                      {e.discount && (
                        <Box component="div">
                          {(
                            ...
                            ` (${e?.discount?.percentage}%) hasta ${new Date(
                              e.discount.expireAt
                            ).toLocaleDateString()}`}
                    ...
                    >
                      ...
                      >
                        {/*  <Button variant='outlined' color='primary' className="buttonSpan buttonHover"> */}
                        {e.discount
