...
export default function PefilUsuario() {
  ...
  const GetUser = useAppSelector((state) => state.userSignin.userInfo);
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="productos"
          element={<ListProducts id={GetUser?._id} />}
        ></Route>
        <Route path="ventas" element={<ListSales id={GetUser?._id} />}></Route>
        <Route
          path="compras"
          element={<ListShopping id={GetUser?._id} />}
        ></Route>
      </Routes>
