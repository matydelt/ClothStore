  ...
  return (
    <Container classes={{ root: classes.containerBenefit }} maxWidth="md">
      ...
      <Grid className="gridBenefit" container spacing={10}>
        ...
        >
          <Button
            onClick={() => handleSubmit("Mujer")}
            className="containedButtonBenefit containedButtonBenefitWoman"
            color="primary"
          ...
          >
            ...
            <Box
              component="img"
              className="imgGenderWoman imgGender"
              src={WomanGender}
              alt="Género Mujer"
            />
            <Box
        ...
        >
          <Button
            onClick={() => handleSubmit("Hombre")}
            className="containedButtonBenefit containedButtonBenefitMan"
            color="primary"
            classes={{ root: classes.button }}
          >
            <Box
            ...
            <Box
              component="img"
              className="imgGenderMan imgGender"
              src={ManGender}
              alt="Género Hombre"
            />
            <Box
            ...
            />
            <Box component="span" className="overlayMan">
              <Typography variant="body1" color="textPrimary">
                Hombre
              </Typography>
            </Box>
        ...
        >
          <Button
            onClick={() => handleSubmit("Niños")}
            className="containedButtonBenefit containedButtonBenefitKid"
            color="primary"
            classes={{ root: classes.button }}
          >
            <Box
            ...
            <Box
              component="img"
              className="imgGenderkid imgGender"
              src={KidGender}
              alt="Género Kid"
            />
            <Box
